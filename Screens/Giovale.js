    ...
    return (
        <View style={styles.background}>
            ...
            <View style={styles.welcome}>
                <Text style={styles.welcomeText}>Giovale Library</Text>
            </View>
            <View style={styles.campus}>{/* this will house the map image of the building */}
                <Image source={require('C:/Users/ringf/Desktop/SeniorProject/GriffGuides/assets/Giovale.jpg')}
                style={styles.campusPic}></Image>
            </View>
            <View style={styles.about}>{/*This gives a history of the building*/}
                <Text style={styles.history}>
                    Giovale Library is a hub for students to have access to all sorts of materials as well as tudoring sessions in private rooms.
                </Text>
            </View>
        </View>
