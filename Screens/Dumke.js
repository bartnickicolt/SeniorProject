    ...
    return (
        <View style={styles.background}>
            ...
            <View style={styles.welcome}>
                <Text style={styles.welcomeText}>Dumke Field</Text>
            </View>
            <View style={styles.campus}>{/* this will house the map image of the building */}
                <Image source={require('C:/Users/ringf/Desktop/SeniorProject/GriffGuides/assets/Dumke.jpg')}
                style={styles.campusPic}></Image>
            </View>
            <View style={styles.about}>{/*This gives a history of the building*/}
                <Text style={styles.history}>
                    Dumke field is home to the Westminster College’s athletics.  The teams who practice and play here include Mens and Womens Soccer, and Lacrosse.
                </Text>
            </View>
        </View>
