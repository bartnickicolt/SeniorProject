    ...
    return (
        <View style={styles.background}>
            ...
            <View style={styles.welcome}>
                <Text style={styles.welcomeText}>Malouf Hall</Text>
            </View>
            <View style={styles.campus}>{/* this will house the map image of the building */}
                <Image source={require('C:/Users/ringf/Desktop/SeniorProject/GriffGuides/assets/Malouf.jpg')}
                style={styles.campusPic}></Image>
            </View>
            <View style={styles.about}>{/*This gives a history of the building*/}
                <Text style={styles.history}>
                Malouf housing classes that are primarily geared towards educational studies.
                </Text>
            </View>
        </View>
