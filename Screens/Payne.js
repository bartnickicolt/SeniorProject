    ...
    return (
        <View style={styles.background}>
            ...
            <View style={styles.welcome}>
                <Text style={styles.welcomeText}>Payne</Text>
            </View>
            <View style={styles.campus}>{/* this will house the map image of the building */}
                <Image source={require('C:/Users/ringf/Desktop/SeniorProject/GriffGuides/assets/Payne.jpg')}
                style={styles.campusPic}></Image>
            </View>
            <View style={styles.about}>{/*This gives a history of the building*/}
                <Text style={styles.history}>
                    Payne is home to Men's and Women's Soccer and Lacrosse.  It also used to serve as a training facility for the Utah Jazz.
                </Text>
            </View>
        </View>
