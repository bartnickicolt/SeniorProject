    ...
    return (
        <View style={styles.background}>
            ...
            <View style={styles.welcome}>
                <Text style={styles.welcomeText}>Stock Hall</Text>
            </View>
            <View style={styles.campus}>{/* this will house the map image of the building */}
                <Image source={require('C:/Users/ringf/Desktop/SeniorProject/GriffGuides/assets/Stock.jpg')}
                style={styles.campusPic}></Image>
            </View>
            <View style={styles.about}>{/*This gives a history of the building*/}
                <Text style={styles.history}>
                Stock is one of three apartment style housing buildings located in the housing village.  Stock is home to mainly upperclassmen and transfer students.
                </Text>
            </View>
        </View>
